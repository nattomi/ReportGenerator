...
\newcommand{\template}[1]{
  \begin{tikzpicture}[remember picture,overlay]
    ...
    ([shift={(-0.2\pgftextwidth,-0.2\pgftextwidth)}]current page.north east) 
    rectangle 
    ([shift={(0.2\pgftextwidth,0.2\pgftextwidth)}]current page.south west);
    \fill[color=white]
    ([shift={(-0.2\pgftextwidth,-3.5cm)}]current page.north east)
    rectangle
    ([shift={(0.2\pgftextwidth,0.2\pgftextwidth)}]current page.south west);
    ...
    \node[anchor=north west] at (20mm,-40mm) {%
