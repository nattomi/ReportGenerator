...
$maxListings_A2 = 3; // number of ability descriptions listed in eval mode A2
...
$allwrong = "Nothing was solved right"; // this message is displayed when no task were solved right
